"""Transformer architecture (RoPE, flash/flex/varlen attention, RMSNorm, SwiGLU).

Base training/inference pipeline for this project; see NOTICE.md for provenance.
"""
