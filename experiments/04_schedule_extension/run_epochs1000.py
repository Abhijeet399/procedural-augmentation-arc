...
PRESETS = {
    ...
    "high": {
        "epochs": 1000,
        "max_augments": 300,
        "checkpoint_epochs": (900, 940, 965, 980, 990, 995, 1000),
        "inference_epoch": 1000,
    },
}
...
args_dict = {
    "name": "submission_run",
    "data_path": Path("assets/combined_rearc_challenges.json"),
    "train_log_file": Path("runs/training_log.txt"),
    "save_path": Path("runs/scratch_rearc_epochs1000.pt"),
